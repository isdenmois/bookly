...
export class DataContext {
  static create() {
    const authors = {
      22: {id: '22', name: 'Стивен Кинг'},
      7612: {id: '7612', name: 'Джон Ирвинг'},
      18953: {id: '18953', name: 'Гиллиан Флинн'},
    }
    ...
    const books = [
      ...
      {id: '318', title: 'Куджо', status: 'read', authors: ['22'], thumbnail: 'https://j.livelib.ru/boocover/1002679006/200/0720/Stiven_King__Kudzho.jpg', rating: 8},
      {id: '450277', title: 'Кто-то взрослый', status: 'read', authors: ['18953'], thumbnail: 'https://i.livelib.ru/boocover/1002780518/200/a4be/Gillian_Flinn__Ktoto_vzroslyj.jpg', rating: 9},
    ]
    // tslint:enable
