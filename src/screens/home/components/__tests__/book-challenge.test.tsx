...
describe('Book challenge', () => {
  ...
  describe('Challenge messages', () => {
    it('parts should return correct messages', () => {
      ...
      expect(getProgressMessage(40, 70)).toBe('Прочитайте книгу до 29.07, чтобы успеть выполнить вызов');
      expect(getForecastMessage(40, 70)).toBe(
        'Прочитайте книгу до 03.07 (раз в 4.6 дня), чтобы сохранить темп и прочитать 80 книг за год',
      );
      expect(getForecastMessage(40, 80)).toBeNull();
      expect(getZerocastMessage(40, 70)).toBeNull();

      expect(getProgressMessage(35, 70)).toBe('Прочитайте книгу до 03.07, чтобы успеть выполнить вызов');
      expect(getForecastMessage(35, 60)).toBe(
        'Прочитайте книгу до 03.07 (раз в 5.2 дня), чтобы сохранить темп и прочитать 70 книг за год',
      );
      ...
      expect(getForecastMessage(30, 70)).toBe(
        'Прочитайте книгу до 04.07 (раз в 6.1 дня), чтобы сохранить темп и прочитать 60 книг за год',
      );
      ...
      expect(getForecastMessage(20, 70)).toBe(
        'Прочитайте книгу до 05.07 (раз в 9.2 дня), чтобы сохранить темп и прочитать 40 книг за год',
      );
      ...
      expect(getForecastMessage(8, 70)).toBe(
        'Прочитайте книгу до 12.07 (раз в 22.9 дня), чтобы сохранить темп и прочитать 16 книг за год',
      );
      ...
      expect(getProgressMessage(41, 70)).toBe('Прочитайте книгу до 03.08, чтобы успеть выполнить вызов');
      ...
      expect(getForecastMessage(35, 70)).toBe(
        'Прочитайте книгу до 03.08 (раз в 6.1 дня), чтобы сохранить темп и прочитать 60 книг за год',
      );
      expect(getForecastMessage(35, 60)).toBeNull();
      ...
      expect(getForecastMessage(25, 70)).toBe(
        'Прочитайте книгу до 04.08 (раз в 8.6 дня), чтобы сохранить темп и прочитать 43 книги за год',
      );
      expect(getForecastMessage(25, 43)).toBeNull();
      ...
      expect(getForecastMessage(20, 70)).toBe(
        'Прочитайте книгу до 07.08 (раз в 10.7 дня), чтобы сохранить темп и прочитать 34 книги за год',
      );
      expect(getZerocastMessage(20, 70)).toBeNull();

      expect(getProgressMessage(8, 70)).toBeNull();
      expect(getForecastMessage(8, 70)).toBe(
        'Прочитайте книгу до 09.08 (раз в 26.8 дня), чтобы сохранить темп и прочитать 14 книг за год',
      );
      expect(getZerocastMessage(8, 70)).toBeNull();

      mockdate.set('2020-07-28');
      lastRead = new Date('2020-07-27');
      expect(getProgressMessage(42, 70)).toBe('Прочитайте книгу до 09.08, чтобы успеть выполнить вызов');
      expect(getForecastMessage(42, 70)).toBe(
        'Прочитайте книгу до 31.07 (раз в 5 дней), чтобы сохранить темп и прочитать 73 книги за год',
      );
      expect(getForecastMessage(42, 73)).toBeNull();
      expect(getProgressMessage(42, 73)).toBe('Прочитайте книгу до 31.07, чтобы успеть выполнить вызов');

      expect(getProgressMessage(51, 90)).toBeNull();
      expect(getZerocastMessage(51, 90)).toBe('Прочитайте книгу до 31.07 (раз в 3 дня), чтобы выйти в 0 до 06.08');
