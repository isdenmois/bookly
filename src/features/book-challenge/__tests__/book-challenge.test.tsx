...
describe('Book challenge', () => {
  ...
  describe('Challenge messages', () => {
    it('should work on the start of the year', () => {
      ...
      expect(getProgressMessage(getProgressDate(0, 70))).toBe(
        'Прочитайте книгу до 05.01, чтобы успеть выполнить вызов',
      );
    ...
    it('should work on the start of the year even when we have negative forecast', () => {
      ...
      expect(getProgressMessage(getProgressDate(0, 70))).toBeNull();
      expect(getForecastMessage(0, 70, lastRead)).toBeNull();
      expect(getZerocastMessage(0, 70, lastRead)).toBeNull();
    ...
    it('parts should return correct messages', () => {
      ...
      expect(getProgressMessage(getProgressDate(40, 70))).toBe(
        'Прочитайте книгу до 01.08, чтобы успеть выполнить вызов',
      );
      ...
      expect(getProgressMessage(getProgressDate(35, 70))).toBe(
        'Прочитайте книгу до 06.07, чтобы успеть выполнить вызов',
      );
      ...
      expect(getProgressMessage(getProgressDate(30, 70))).toBeNull();
      ...
      expect(getProgressMessage(getProgressDate(20, 70))).toBeNull();
      ...
      expect(getProgressMessage(getProgressDate(41, 70))).toBe(
      ...
      expect(getProgressMessage(getProgressDate(35, 70))).toBeNull();
      ...
      expect(getProgressMessage(getProgressDate(25, 70))).toBeNull();
      ...
      expect(getProgressMessage(getProgressDate(8, 70))).toBeNull();
      expect(getForecastMessage(8, 70, lastRead)).toBe(
      ...
      expect(getProgressMessage(getProgressDate(42, 70))).toBe(
        'Прочитайте книгу до 11.08, чтобы успеть выполнить вызов',
      );
      ...
      expect(getProgressMessage(getProgressDate(42, 73))).toBe(
        'Прочитайте книгу до 02.08, чтобы успеть выполнить вызов',
      );

      expect(getProgressMessage(getProgressDate(51, 90))).toBe(
        'Прочитайте книгу до 29.07, чтобы успеть выполнить вызов',
      );
  ...
  it('getProgressMessage', () => {
    mockdate.set('2020-07-31');
    expect(getProgressMessage(getProgressDate(43, 74))).toBe('Прочитайте книгу до 04.08, чтобы успеть выполнить вызов');
    ...
    mockdate.set('2020-08-11');
    expect(getProgressMessage(getProgressDate(54, 90))).toBeNull();
    expect(getProgressMessage(getProgressDate(46, 76))).toBe('Прочитайте книгу до 13.08, чтобы успеть выполнить вызов');
    expect(getProgressMessage(getProgressDate(46, 75))).toBe('Прочитайте книгу до 16.08, чтобы успеть выполнить вызов');
    expect(getProgressMessage(getProgressDate(54, 89))).toBe('Прочитайте книгу до 13.08, чтобы успеть выполнить вызов');
  });
